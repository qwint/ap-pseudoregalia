...
item_term_lookup = {
    "".join(item.split()): item
    for item in item_table.keys()
}
item_term_lookup["ClingPart"] = "Cling Part"
...
item_frequencies = {
    ...
    "Progressive Slide": 2,
    "Air Kick": 4,
    "Progressive Dream Breaker": 3,  # Will need to change this later when dream breaker stops being locked to vanilla
}
